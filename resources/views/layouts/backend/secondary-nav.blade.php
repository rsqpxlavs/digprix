        ...
        <nav class="navbar navbar-toggleable-sm">
            ...
            <div id="mai-navbar-collapse" class="navbar-collapse collapse mai-nav-tabs">
                <ul class="nav navbar-nav">
                    <li class="nav-item parent {{ return_if(on_route('admin.dashboard'), 'open') }}">
                        ...
                        <ul class="mai-nav-tabs-sub mai-sub-nav nav">
                            <li class="nav-item">
                                <a href="{{ route('admin.dashboard') }}" class="nav-link {{ return_if(on_route('admin.dashboard'), 'active') }}">
                                    <span class="icon s7-monitor"></span>
                                    <span class="name">Dashboard</span>
                                </a>
                            </li>
                            <li class="nav-item dropdown parent">
                                <a href="ui-elements.html" data-toggle="dropdown" class="nav-link"><span class="icon s7-diamond"></span><span class="name">UI Elements</span></a>
                                <div role="menu" class="dropdown-menu mai-sub-nav">
                                    <a href="ui-general.html" class="dropdown-item">General</a>
                                    <a href="ui-panels.html" class="dropdown-item">Panels</a>
                            ...
                            <li class="nav-item dropdown parent">
                                <a href="ui-elements.html" data-toggle="dropdown" class="nav-link"><span class="icon s7-diamond"></span><span class="name">Components</span></a>
                                <div role="menu" class="dropdown-menu mai-sub-nav">
                            ...
                            <li class="nav-item dropdown parent">
                                <a href="plugins.html" data-toggle="dropdown" class="nav-link"><span class="icon s7-plugin"></span><span class="name">Plugins</span></a>
                                <div role="menu" class="dropdown-menu mai-sub-nav">
                                    <a href="ui-modals.html" class="dropdown-item">Modals</a>
                                    <a href="ui-nestable-lists.html" class="dropdown-item">Nestable Lists</a>
