...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery__ = __webpack_require__(62);
...
function afterInitialAjaxUpload() {
    var uploadField = $("input#upload-field");
...
$(document).ready(function () {
    var uploadField = $("input#upload-field");
    var output = $("#progress-output");
    var saveClrBtns = $("#pic-save-section");
    ...
    uploadField.on('change', function () {
        if (validateImage(uploadField.val())) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('' + trans._ajaxUploadHIT, data, config).then(function (res) {
